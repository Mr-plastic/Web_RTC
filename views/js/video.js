...
//text-chat 
let toggleChatButton = document.getElementById("toggle-chat");
...
joinButton.addEventListener("click", function () { //join room btn
    if (roomInput.value == "") {
      ...
      divVideoChat.classList.remove("hidden");
      toggleChatButton.classList.remove("hidden"); 
    }
});

toggleChatButton.addEventListener("click", () => { //swap chatbutton to visible
  if (textChat.classList.contains("hidden")) {
      divVideoChat.classList.add("shrink");
      textChat.classList.remove("hidden");
      textChat.classList.add("visible");
  } else {
      textChat.classList.add("visible");
      textChat.classList.add("hidden");
      divVideoChat.classList.remove("shrink");
  }
});
...
socket.on("ready", function () {
    if (creator) {
      ...
      datachannel.onopen = () => console.log("text-chat is build");
